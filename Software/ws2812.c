...
static const LED ColorMapValues[NUM_COLOR] =
{
    ...
    {0x0F, 0x00, 0x00}, //COLOR_RED,
    {0x00, 0x0F, 0x00}, //COLOR_GREEN,
    {0x00, 0x00, 0x0F}  //COLOR_BLUE,
};
...
void showStrip()
{
    ...
    for ( i = 0; i < NUM_LEDS; i++)
    {
        ...
        */
        ...
        uint8_t *rgb = (uint8_t *)&ColorMapValues[((leds[i/4]>>(2*(i%4)))&0x03)]; // get GRB color for this LED

        #ifdef SIMULATE
        printf("LED: %d:%d:%d->Raw %02X->Color:\t",i, i/4, i%4,((leds[i/4]>>(2*(i%4)))&0x03));
        #endif
